...
//               Upload
//             </button>
//             <div className="img w-10 h-10 rounded-full hover:ring-2 hover:ring-gray-400">
//               <img
//                 src={profile}
//                 alt="profile"
        ...
        <div className="hidden md:flex justify-between px-7 p-2">
          ...
          <div className="profile flex items-center">
            ...
            <div className="relative group">
              <div
                className="img w-10 h-10 rounded-full hover:ring-2 hover:ring-gray-400 cursor-pointer"
                onClick={handleProfileClick}
              >
                <img
                  src={profile}
                  alt="profile"
                  className="img w-10 h-10 bg-red-300 rounded-full object-cover"
                />
              </div>
              {/* Profile menu */}
              {isProfileOpen && (
